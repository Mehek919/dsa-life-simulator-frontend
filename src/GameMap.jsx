...
const CHAPTERS = {
  ...
  14: { district: 4, company: 'Microsoft',  title: 'Gates of Redmond',                   badge: '🪟', color: '#00a4ef', problems: 15 },
  15: { district: 4, company: 'Microsoft',  title: 'Azure Depths',                       badge: '☁️', color: '#00a4ef', problems: 15 },
  16: { district: 4, company: 'Microsoft',  title: 'Redmond Boss Fight',                 badge: '⚔️', color: '#00a4ef', problems: 5  },
  17: { district: 4, company: 'Oracle',     title: 'The Oracle Labyrinth',               badge: '🏛️', color: '#f80000', problems: 10 },
  18: { district: 4, company: 'Oracle',     title: 'Database Dungeons',                  badge: '🗄️', color: '#f80000', problems: 10 },
  19: { district: 4, company: 'Oracle',     title: "Larry's Vault",                      badge: '🔒', color: '#f80000', problems: 5  },
  20: { district: 4, company: 'Salesforce', title: 'Salesforce Tower',                   badge: '☁️', color: '#00a1e0', problems: 10 },
  21: { district: 4, company: 'Salesforce', title: 'CRM Colosseum',                      badge: '🏟️', color: '#00a1e0', problems: 10 },
  22: { district: 4, company: 'Salesforce', title: "Marc's Final Boss",                  badge: '⚔️', color: '#00a1e0', problems: 5  },
  23: { district: 4, company: 'Adobe',      title: 'Adobe Studio',                       badge: '🎨', color: '#ff0000', problems: 10 },
  24: { district: 4, company: 'Adobe',      title: 'Creative Cloud Wars',                badge: '🖌️', color: '#ff0000', problems: 10 },
  25: { district: 4, company: 'Adobe',      title: 'Render Farm Boss',                   badge: '⚔️', color: '#ff0000', problems: 5  },
  26: { district: 4, company: 'Broadcom',   title: 'Broadcom Chip Floor',                badge: '💾', color: '#cc092f', problems: 10 },
  27: { district: 4, company: 'Broadcom',   title: 'Silicon Valley Hard',                badge: '🔬', color: '#cc092f', problems: 10 },
  28: { district: 4, company: 'Broadcom',   title: 'ASIC Boss Fight',                    badge: '⚔️', color: '#cc092f', problems: 5  },
};
...
function DistrictSection({ districtId, district, chapters, progress, unlockedChapters, onChapterClick }) {
  ...
  const isUnlocked   = districtId === 1 || districtId === 4 || unlockedChapters.some(id => chapters[id]?.district === Number(districtId));
...
export default function GameMap({ user, userData, setUserData }) {
  ...
  // Chapters unlock: ch1 and ch14 always open; others unlock if prev chapter has >=1 solve
  const getUnlockedChapters = useCallback(() => {
    ...
    for (const id of chapterIds) {
      ...
      // Different district boundary — always unlock
  ...
  }, [user?.uid, userData?.currentStreak]);
